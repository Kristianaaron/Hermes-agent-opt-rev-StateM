...
_LABELS = (
    ...
    "specific constraint",
    "requested code or file modification",
    "request to inspect without modifying",
)
_FAST_LABELS = {
    "requested software operation",
    "software target",
...
_MUTATION_LABELS = {"requested code or file modification"}
_INSPECTION_LABELS = {"request to inspect without modifying"}
...
def _extract(text: str) -> dict[str, Any]:
    ...
    mutation_score = strongest(_MUTATION_LABELS)
    inspection_score = strongest(_INSPECTION_LABELS)
    ...
    evidence = {
        ...
        "mutation_intent": mutation_score >= 0.30 and mutation_score >= inspection_score,
